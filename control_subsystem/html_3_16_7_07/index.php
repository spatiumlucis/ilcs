				...
				<div class = "modal-content">
					...
					<div class = "modal-body">
						...
						<div class="form-group">
							...
							<select name = "room_light_threshold" id = "room_light_threshold" class="form-control">
						...
						<div class="form-group">
							...
							<select name = "room_color_threshold" id = "room_color_threshold" class="form-control">
